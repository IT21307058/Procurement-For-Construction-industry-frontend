        ...
        <div className='d-flex'>
          ...
          <div className="search_add mt-4 mb-4 d-flex justify-content-between">
            ...
            <div className="add_btn ">
              <Button variant="primary" className="btn-info" onClick={addmaterial} ><b>+ New Draft Order</b></Button>
            </div>
          </div>
          ...
          <Card className='shadow'>
            <table class="table">
              ...
              <tbody>
              <Button variant="primary" className="btn-info" onClick={updatematerial} ><b>Update Materials</b></Button>
